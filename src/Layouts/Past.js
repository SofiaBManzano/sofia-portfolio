    ...
    <>
      ...
      <article className="c-main__block">
        ...
        <p className="c-main__text">
          ...
          amor por la pintura, heredé el gusto por el diseño y la fotografía
        ...
        <p className="c-main__text">
          ...
          conciertos. A medida que ganaba experiencia, sentí la necesidad de
      ...
      <article className="c-main__block">
        ...
        <p className="c-main__text">
          ...
          perfecta en cada imagen, me aventuré en el mundo del etalonaje de
          video. Tuve la oportunidad de participar en proyectos donde pude
